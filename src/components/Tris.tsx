...
const knowledge: KnowledgeItem[] = [
  ...
  { keywords: ["sgd", "sistema sgd", "gestão diária"], title: "SGD", description: "SGD — login do aplicativo e manual na pasta Manuais SGD (SharePoint Escrita Fiscal).", href: "https://sgd.dominiosistemas.com.br/login.html", step: 1, stepLabel: "Workspace" },
  ...
  { keywords: ["solicitação serviço", "solicitacao servico", "hardware", "periféricos", "perifericos", "troca equipamento", "ti", "it"], title: "Solicitação Serviço", description: "Solicitar troca de hardware e periféricos (ServiceNow).", href: "https://trenterprise.service-now.com/esc?id=my_requests", step: 1, stepLabel: "Workspace" },
  { keywords: ["myexpenses", "my expenses", "reembolso", "reembolsos", "notas fiscais", "despesas"], title: "MyExpenses", description: "Solicitação de reembolso conforme notas fiscais (Infor).", href: "https://mingle-portal.inforcloudsuite.com/THOMSONREUTERS_PRD/6a0f40b9-a414-4172-b22c-6ccf437c2126?favoriteContext=xm_default&LogicalId=lid%3A%2F%2Finfor.xm.infor_prd", step: 1, stepLabel: "Workspace" },
  ...
  { keywords: ["atrium", "all tr tools", "tr tools", "aplicativos tr", "menu aplicativos", "popular tools"], title: "Atrium", description: "Menu com todos os aplicativos da Thomson Reuters — All TR Tools (Popular Tools no SharePoint).", href: "https://trten.sharepoint.com/SitePages/Popular-Tools.aspx", step: 1, stepLabel: "Workspace" },
  ...
  // IAs
  { keywords: ["ia", "ias", "inteligência artificial", "ai", "assistente"], title: "IAs Utilizadas", description: "16 IAs disponíveis incluindo IGOR, Chain AI Tria, Ask GPT, Metaprompting e mais.", step: 5, stepLabel: "Tech" },
  { keywords: ["igor", "roteiro", "roteiros"], title: "IGOR", description: "Instrutor de Geração e Otimização de Roteiros.", href: "https://aiplatform.thomsonreuters.com/ai-platform/ai-chains/use/34b45254-f1ac-4f0d-a7bc-74aaaee96e88?sidebar=instructions", step: 5, stepLabel: "Tech" },
  { keywords: ["rubrica", "rubricas", "fórmula", "fórmulas"], title: "Rubricas com Fórmulas", description: "IA para análise de rubricas com fórmulas.", href: "https://aiplatform.thomsonreuters.com/ai-platform/ai-chains/use/b653d9c8-da78-4860-9347-e08a8c97c145?sidebar=instructions_auto", step: 5, stepLabel: "Tech" },
  { keywords: ["tradução", "traduzir", "inglês", "ingles"], title: "Tradução - Inglês", description: "IA para tradução de textos para inglês.", href: "https://aiplatform.thomsonreuters.com/ai-platform/ai-chains/use/37ec1afe-fd69-44b6-95ae-bef608ce57d1", step: 5, stepLabel: "Tech" },
  { keywords: ["gpt", "ask gpt", "chat gpt"], title: "Ask GPT 5.2", description: "Acesso ao GPT para perguntas e respostas.", href: "https://dataandanalytics.int.thomsonreuters.com/ai-platform/ai-experiences/use/cd8d90f6-ce37-4e69-9433-92e658a33675", step: 5, stepLabel: "Tech" },
  { keywords: ["psai", "valida psai", "validação", "tokens"], title: "Valida PSAI - 200k Tokens", description: "Validação de PSAIs com suporte a 200k tokens.", href: "https://dataandanalytics.int.thomsonreuters.com/ai-platform/ai-chains/use/d80f55af-7d45-420c-adc1-065743520fd4", step: 5, stepLabel: "Tech" },
  { keywords: ["chain", "tria", "dominio ia"], title: "CHAIN AI TRIA - DOMINIO", description: "IA de triagem do Domínio.", href: "https://dataandanalytics.int.thomsonreuters.com/ai-platform/ai-chains/use/3679317a-l205-4c29-a847-08c8c93fb592", step: 5, stepLabel: "Tech" },
  { keywords: ["metaprompting", "prompt", "gerar prompt", "fix prompt"], title: "Metaprompting", description: "Gere ou corrija seus prompts para as IAs.", href: "https://aiplatform.thomsonreuters.com/ai-platform/ai-experiences/use/53737406-b11d-4b13-afd2-57e1e33c1c49?sidebar=instructions_auto", step: 5, stepLabel: "Tech" },
